...
exports.MOCK_SAFETY_TEST_CASES = void 0;
exports.evaluateSafetyGate = evaluateSafetyGate;
exports.runPreflightSafetyGate = runPreflightSafetyGate;
const fs_1 = __importDefault(require("fs"));
exports.MOCK_SAFETY_TEST_CASES = {
    VALID: {
        trade_size_ton: 10,
        spread_bps: 300,
...
function evaluateSafetyGate(data, options = {}) {
...
function runPreflightSafetyGate(options) {
    let data = null;
    if (options.inputPath && fs_1.default.existsSync(options.inputPath)) {
        const content = fs_1.default.readFileSync(options.inputPath, 'utf-8');
        data = JSON.parse(content);
    }
    else {
        const mockCase = options.mockCase ?? 'VALID';
        data = exports.MOCK_SAFETY_TEST_CASES[mockCase];
    }
